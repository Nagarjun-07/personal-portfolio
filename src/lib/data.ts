...
export const data = {
  ...
  projects: [
    ...
    },
    {
      ...
      tech: ["Federated Learning", "PyTorch", "Whisper-v2", "Hugging Face"],
      date: "August 2024",
  ...
  skills: {
    ...
    frameworks_and_libraries: ["React.Js", "Next.Js", "Flask", "PyTorch", "Hugging Face"],
    ai_and_ml: ["Machine learning", "Deep Learning", "Neural Networks", "RAG", "OpenAI", "Genkit AI", "Federated Learning"],
